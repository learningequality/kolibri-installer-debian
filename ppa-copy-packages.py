...
Typical usage:
    ...
    - build a kolibri package for trusty
    - dput ppa:build/kolibri-source_0.9.0~b2-0ubuntu1_source.changes
    - wait for it to be built
    - run python ppa-kolibri-proposed-copy-packages.py
...
TARGET_SERIESES = ['trusty', 'xenial', 'bionic', 'eoan', 'focal']
POCKET = 'Release'
